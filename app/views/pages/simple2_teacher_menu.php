		...
		<div class="row">
			<div class="col-md-3">
				...
				<div class="my-account">
					<ul class="ul-sub-menu" style="padding-left: 0px;">
						<li class="li-sub-menu list-style-none menu-main-item"> <span class="text-uppercase">Giáo Viên</span>
						</li>
						<li class="li-sub-menu list-style-none">
							<a href="#"> <i class="glyphicon glyphicon-globe icon-menu"></i><span>Tạo chương</span>
							</a>
						</li>
						<li class="li-sub-menu list-style-none">
						...
						<li class="li-sub-menu list-style-none">
							<a href="#"> <i class="glyphicon glyphicon-phone icon-menu"></i><span>Danh sách các bài học</span>
							</a>
						</li>
						...
						<li class="li-sub-menu list-style-none" id="dang-ky-day-kem">
							<a href="#"> <i class="glyphicon glyphicon-sunglasses icon-menu"></i><span>Xem danh sách lớp</span>
							</a>
						</li>


						<li class="li-sub-menu list-style-none" id="dang-ky-day-kem">
							<a href="Teacher/createExamSelection"> <i class="glyphicon glyphicon-sunglasses icon-menu"></i><span>Tạo đề thi</span>
							</a>
						</li>
						...
						<li class="li-sub-menu list-style-none menu-main-item"> <span class="text-uppercase">Tài khoản</span>
						</li>
						<li class="li-sub-menu list-style-none" id="thong-tin-tai-khoan">
							<a href="#"> <i class="glyphicon glyphicon-info-sign icon-menu"></i><span>Thông tin tài khoản</span>
							</a>
						</li>
						...
						<li class="li-sub-menu list-style-none" id="doi-mat-khau">
							<a href="#"> <i class="glyphicon glyphicon glyphicon-lock icon-menu"></i><span>Đổi mật khẩu</span>
							</a>
						</li>
					</ul>
				</div>
				<script>
					$(document).ready(function () {
					                            ...
					                            if (url.indexOf('danh-sach-de-thi') > 0 || url.indexOf('danh-sach-chuong.html') > 0 || url.indexOf('tao-chuong.html') > 0 || url.indexOf('tao-de-thi-theo-lo.html') > 0) {
					                            ...
					                            if (url.indexOf('danh-sach-bo-de') > 0 || url.indexOf('bo-de') > 0 || url.indexOf('tao-cau-truc-de-thi-v1.html') > 0 || url.indexOf('cau-truc-de-thi.html') > 0) {
