...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>TN-ONLINE</b>ADMIN</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Ở đây hiện tên user đăng nhập</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Ở đây hiện tên user đăng nhập
                  <small>Ở đây hiện vai trò của user</small>
                </p>
              </li>
              <!-- Menu Body -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Khối</span>
          </a>
        </li>
        <li><a href="documentation/index.html"><i class="fa fa-book"></i> <span>Môn</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
